...
The map about shows the __total number of cases__ for each region geographically. 

*Note: the North American and Central American regions were aggregated to match available spatial data*
